...
Sprint 0 is complete. Sprint 1 is in progress, and `FOUND-001` is complete.

The repository now has a Django 5.2 LTS foundation, reproducible dependency lock,
pytest-django tests, Ruff checks, and a verified installation of the published
`python-ai-toolkit==1.0.0` distribution.

The next approved task is `FOUND-002 — Add accounts, organizations, memberships,
and roles`.
